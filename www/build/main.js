...
var StockProvider = /** @class */ (function () {
    ...
    // New package
    StockProvider.prototype.update_packages = function (move_line_ids, result_package_id, action, partner_id) {
    ...
    StockProvider.prototype.transfer_package_moves_to_package = function (package_id, result_package_id, action) {
        var self = this;
        var model;
        var values = {
...
var StockMoveListPage = /** @class */ (function () {
    ...
    StockMoveListPage.prototype.update_packages = function (move_ids, package_id, action, partner_id) {
        ...
        this.stockInfo.update_packages(move_ids, package_id, action, partner_id).then(function (resultado) {
            if (resultado[0]) {
    ...
    StockMoveListPage.prototype.add_package_content_to_package = function (package_id) {
        ...
        this.stockInfo.transfer_package_moves_to_package(package_id, this.current_selected_pkg, action).then(function (linea) {
            console.log(linea);
            _this.reload_with_data(_this.current_selected_partner, _this.current_selected_pkg, _this.current_shipping_type);
        }).catch(function (mierror) {
